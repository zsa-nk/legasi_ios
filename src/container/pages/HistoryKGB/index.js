...
const HistoryKGB = ({navigation}) => {
  ...
  const fetchData = () => {
    ...
    fetch_retry(
      ...
      .then(res => res.json())
      .then(json => {
        setRiwayatKgb(json.data);
        storeObjectData('dataKgbnUser', json.data);
      })
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={styles.contentWrapper}>
        ...
        <View style={styles.headerWrapper}>
          <View style={styles.header}>
            ...
            <View style={styles.headerTitleWrapper}>
              <Text style={styles.headerTitle}>Riwayat KGB</Text>
        ...
        <View style={styles.app}>
          {riwayatKgb.length > 0
            ? riwayatKgb.map((data, index) => (
                <CollapsibleCard
                  key={index}
                  title={'No SK : ' + data.no_sk}
                  ...
                  <View style={{padding: 8}}>
                    ...
                    <View
                      ...
                      <Text style={{fontSize: 14}}> Link Berkas : </Text>
                      <Text
                        style={{fontSize: 14, fontFamily: 'Poppins-SemiBold'}}>
                        {data.link_berkas}
                      </Text>
